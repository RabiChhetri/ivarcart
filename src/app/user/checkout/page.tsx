      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              <PhoneIcon className="absolute left-3 top-3 text-green-600 size={18}" />
              <input
                type="text"
            ...
            <div className="flex gap-2 mt-3">
              <input
                ...
                className="flex-2 border rounded-lg p-3 text-sm focus:ring-2 focus:ring-green-500 outline-none"
              />
              <button
