...
import { ChevronDown, ChevronUp, CreditCard, MapPin, Package, Truck, TruckIcon } from "lucide-react";
...
function UserOrderCard({ order }: { order: IOrder }) {
  ...
  return (
    <motion.div
      ...
      className="bg-white rounded-2xl border border-gray-100 shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden mb-4"
    >
      {/* Header Section */}
      ...
      <div className="p-5 space-y-4">
        ...
        <div className="flex items-start gap-2 text-gray-700 text-sm">
          ...
          <span className="leading-tight">{order.address.fullAddress}</span>
        </div>
            ...
            <div className="mt-3 space-y-3">
              {order.items.map((item, index) => (
                ...
                >
                  ...
                  {/* Right Side: Price (Corrected Alignment) */}
