  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen text-center p-6 bg-linear-to-b from-green-100 to-white'>
      ...
      >
        ...
        <h1 className='text-4xl md:text-5xl font-extrabold text-green-700'>Ivarcart</h1>
    </motion.div>
    <motion.p 
     initial={{
        opacity:0,
    ...
    >
        IvarCart is your one-stop destination for fresh groceries, organic produce, and daily essentials—delivered to your doorstep
    </motion.p>
    ...
    initial={{
      ...
      className='inline-flex items-center gap-2 bg-green-500 hover:bg-green-700 text-white font-semibold py-3 px-8 rounded-2xl shadow-md transition-all duration-200 mt-10'
    onClick={()=>nextStep(2)}
    >Next
    <ArrowRight/>
    </motion.button>
